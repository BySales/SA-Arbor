...
from .views import (
    solicitacao_list, solicitacao_create, solicitacao_update, solicitacao_delete, solicitacao_detail, # Adicionamos a view de detalhe
...
urlpatterns = [
    ...
    # --- URLs de Solicitação (COM A NOVA ROTA) ---
    ...
    path('solicitacoes/<int:pk>/', solicitacao_detail, name='solicitacao_detail'), # <<< ROTA DE DETALHES
